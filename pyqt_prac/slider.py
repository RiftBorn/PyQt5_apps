...
class Window(QWidget):
    ...
    def init_ui(self):
        ...
        self.b1.clicked.connect(lambda: self.btn_clk(self.b1, 'Hello from Clear'))  # Lambda Design
        self.b2.clicked.connect(lambda: self.btn_clk(self.b2, 'Hello from Print'))  # Lambda Design
